public class TestBankAccount {
    public static void main(String[] args) {
        ...
        System.out.println("Savings account balance after withdrawing 50.00" + savingsAccount.getBalance());
        ...
        for (int i = 1; i <= 6; i++) {
            ...
            System.out.println("No earned interest, maintenance fee of 8.0 has been deducted from current balance ");
            ...
            System.out.println("Earned interest (0.07/12 * 1000 = 5.83),no maintenance fee ");
